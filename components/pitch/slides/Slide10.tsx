    ...
    <SlideContainer>
      ...
      >
        ...
        >
          ...
          <span style={{ color: 'var(--sun)', fontStyle: 'italic' }}>simple</span>
        </motion.h1>
        ...
        >
          ...
          >
            On aide les <span style={{ color: 'var(--sun)', fontWeight: 600 }}>lycéens</span> à
            choisir leur voie, et on aide les{' '}
            <span style={{ color: 'var(--pivot)', fontWeight: 600 }}>écoles</span> à trouver leurs
            futurs étudiants.
          </p>
        </motion.div>
