            ...
            <ul className="space-y-3 mb-4">
              <li className="flex items-start gap-3 text-snow/90">
                ...
                <span className="text-base leading-snug">
                  Affiliation par lead étudiant transmis à l&rsquo;école
                  (avec consentement)
                </span>
              </li>
              <li className="flex items-start gap-3 text-snow/90">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-snow/65 text-sm">
                  Sur la pertinence des leads transmis
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-snow/70 mb-6">
                Cap<span style={{ color: "var(--sun)" }}>&rsquo;</span> ne
                référence que des écoles qui respectent des standards stricts.
              </p>
              ...
              <p className="text-snow/60 text-sm italic border-t border-night-200 pt-4">
                Ces critères garantissent que les leads que tu envoies vont à
                des étudiants qui choisiront en connaissance de cause.
              </p>
            </motion.div>
          </motion.div>
        )}
