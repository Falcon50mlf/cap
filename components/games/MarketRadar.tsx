...
const ROUNDS: Round[] = [
  {
    ...
    B: {
      ...
      items: [
        ...
        {
          id: 'b1-3',
          profile: 'Famille de 4 personnes en banlieue, conduit une Peugeot 3008 depuis 4 ans',
          expected: 'CA',
        },
        {
          id: 'b1-4',
    ...
    C: {
      ...
      options: [{ value: 6.7 }, { value: 15, correct: true }, { value: 20 }, { value: 30 }],
      unit: '%',
    },
  },
  {
    brand: 'Decathlon',
    context: 'Decathlon vend des articles de sport accessibles, en magasins et online.',
    A: {
      intro: 'Pour chaque produit, identifie le type de marché vis-à-vis de Decathlon.',
      items: [
    ...
    B: {
      ...
      items: [
        {
          id: 'b2-1',
          profile: 'Adolescent qui veut commencer le foot mais ses parents trouvent ça trop cher',
          expected: 'NCR',
        },
        {
          id: 'b2-2',
        ...
        {
          id: 'b2-4',
          profile: 'Pratiquante de yoga qui achète actuellement chez Lululemon mais trouve ça cher',
          expected: 'CP',
        },
      ],
    },
    C: {
      ...
      options: [{ value: 25 }, { value: 37.5, correct: true }, { value: 50 }, { value: 12 }],
      unit: '%',
    },
  },
  {
    brand: 'Netflix',
    context: 'Netflix est un service de streaming vidéo par abonnement (séries, films, docus).',
    A: {
    ...
    B: {
      ...
      items: [
        ...
        {
          id: 'b3-2',
          profile: 'Personne sans Internet ni TV connectée, ne consomme que la radio FM',
          expected: 'NCA',
        },
        {
          id: 'b3-3',
          profile: 'Couple parisien abonné à Netflix Premium depuis 5 ans, regarde 10h/semaine',
          expected: 'CA',
        },
        {
          id: 'b3-4',
          profile: 'Étudiant abonné uniquement à Disney+ pour Marvel, jamais essayé Netflix',
          expected: 'CP',
        },
      ],
    },
    C: {
      ...
      options: [{ value: 5 }, { value: 20, correct: true }, { value: 50 }, { value: 10 }],
      unit: '%',
    },
  },
];
...
export default function MarketRadar() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto">
      {/* Header round */}
      <div
        className="rounded-3xl p-5 md:p-6 border-l-4 mb-5 bg-night-soft"
      ...
      >
        ...
        <p className="text-snow/85 text-base md:text-lg leading-relaxed">{round.context}</p>
      </div>
...
function PhaseC({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <div
        className="rounded-3xl p-6 md:p-7 border-2 mb-5"
        style={{ borderColor: ACCENT, background: `${ACCENT}08` }}
      >
        <p className="text-snow text-lg md:text-xl leading-relaxed mb-6">{data.question}</p>
