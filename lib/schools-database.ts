    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          label: "Tertiaire",
          value:
            "Production de services (commerce, transport, finance, tourisme, conseil, santé).",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          value:
            "2 à 100 associés. Cadre rigide rassurant, idéal pour PME familiales.",
        },
        {
        ...
        },
        {
          ...
          value:
            "Salariés associés majoritaires. Gouvernance démocratique, partage des bénéfices.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          label: "E · Économique",
          value:
            "Croissance, taux de change, inflation, pouvoir d'achat, cycle économique.",
        },
        {
          label: "S · Socioculturel",
          value:
            "Démographie, mode de vie, valeurs, niveau d'éducation, attitudes consommation.",
        },
        {
          label: "T · Technologique",
          value:
            "Innovation, R&D, brevets, dépenses publiques en techno, transferts.",
        },
        {
          label: "E · Écologique",
          value:
            "Lois sur l'environnement, traitement des déchets, consommation d'énergie, RSE.",
        },
        {
          label: "L · Légal",
          value:
...
const SUBMODULE_4: Submodule = {
  ...
  sections: [
      ...
      items: [
        {
          ...
          value:
            "Pas encore consommateur, mais pourrait le devenir (manque d'info, prix, accès…).",
        },
        {
        ...
        },
        {
          ...
          value:
            "Consomme un produit similaire chez un concurrent. Cible de conquête.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      formula:
        "Taux de pénétration = (Demande actuelle / Demande potentielle) × 100",
    },
  ],
};
...
export function getSubmodule(
  ...
  return getModule(schoolId, moduleId)?.submodules.find(
    (s) => s.id === submoduleId,
  );
}
