...
export const gameComponents: Record<string, ComponentType> = {
  'mapping-concurrentiel': dynamic(() => import('@/components/games/MappingConcurrentiel'), {
    ssr: false,
  }),
  'mix-marketing-4p': dynamic(() => import('@/components/games/MixMarketing4P'), { ssr: false }),
  // UCL · Gestion d'entreprise
  'ucl-entreprise-explorer': dynamic(() => import('@/components/games/EntrepriseExplorer'), {
    ssr: false,
  }),
